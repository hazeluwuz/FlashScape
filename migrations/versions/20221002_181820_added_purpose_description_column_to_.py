...
def upgrade():
    ...
    if environment == "production":
        op.add_column('classes', sa.Column('description', sa.String(length=255), nullable=True), schema=SCHEMA)
        op.add_column('classes', sa.Column('purpose', sa.String(length=255), nullable=True), schema=SCHEMA)
    else:
